-- Script Date: 10/02/2025 12:23  - ErikEJ.SqlCeScripting version 3.5.2.95
INSERT INTO [Posts] ([Id],[Title],[ShortDescription],[ThumbnailUrl],[Content],[Slug],[PublishedDate],[Author],[IsPublished]) VALUES (
'061265f3-cdfb-428f-8c8d-08db6cab4598','Building a Simple Navigation Bar: A Step-by-Step Guide','A navigation bar is an essential component of any website or web application, providing users with easy access to different sections and pages.','https://images.pexels.com/photos/109371/pexels-photo-109371.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1','## Introduction 
...
','simple-navigation-bar','2023','Sameer Saini',1);
INSERT INTO [Posts] ([Id],[Title],[ShortDescription],[ThumbnailUrl],[Content],[Slug],[PublishedDate],[Author],[IsPublished]) VALUES (
'7ced7773-a5e1-4eaa-8c8a-08db6cab4598','Mastering HTTP Requests with JavaScript: A Comprehensive Guide','In the ever-evolving landscape of web development, interacting with external APIs and sending HTTP requests is a fundamental skill. JavaScript, being the language of the web, provides developers with several methods and libraries to efficiently handle this task. ','https://images.pexels.com/photos/5483077/pexels-photo-5483077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1','In the ever-evolving landscape of web development, interacting with external APIs and sending HTTP requests is a fundamental skill. JavaScript, being the language of the web, provides developers with several methods and libraries to efficiently handle this task. In this comprehensive guide, we will delve into the world of making HTTP requests with JavaScript. We will explore different approaches, ranging from the traditional XMLHttpRequest to the modern Fetch API and the powerful Axios library. By the end of this article, you will be equipped with the knowledge and tools to effortlessly retrieve data from remote servers and APIs. 
...
','http-requests-javascript','2023','Sameer Saini',1);
INSERT INTO [Posts] ([Id],[Title],[ShortDescription],[ThumbnailUrl],[Content],[Slug],[PublishedDate],[Author],[IsPublished]) VALUES (
'81495368-62a1-434c-7268-08db615ccdfb','Creating a Simple Calculator Application using ASP.NET Core Console App','ASP.NET Core is a powerful framework for building cross-platform web applications. While it is commonly used for developing web applications, ASP.NET Core can also be leveraged to create console applications. In this blog post, we will explore in detail how to create a simple calculator application using ASP.NET Core console app. We will cover the step-by-step process of setting up the project, implementing the calculator logic, and running the application. So, let''s get started!','https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1','## Introduction 
...
','simple-calculator-app-aspnet-core','2023','Sameer Saini',1);
INSERT INTO [Posts] ([Id],[Title],[ShortDescription],[ThumbnailUrl],[Content],[Slug],[PublishedDate],[Author],[IsPublished]) VALUES (
'908ba10a-f3cd-4918-8c8b-08db6cab4598','Building a Simple Web API Using C# and .NET Core: A Step-by-Step Guide','Building a robust and efficient web API is a fundamental skill for modern application development. In this comprehensive guide, we will walk you through the process of creating a simple web API using C# and .NET Core.','https://images.pexels.com/photos/7367/startup-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1','## Introduction 
...
','web-api-csharp','2023','Sameer Saini',1);
INSERT INTO [Posts] ([Id],[Title],[ShortDescription],[ThumbnailUrl],[Content],[Slug],[PublishedDate],[Author],[IsPublished]) VALUES (
'9449dc77-3fc4-4b72-8c8c-08db6cab4598','Reading an Excel File in C#: A Step-by-Step Guide','Reading data from Excel files is a common requirement in many applications. In this comprehensive guide, we will walk you through the process of reading an Excel file in C# using the .NET framework','https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',' 
...
','html-website-using-chatgpt','2023','Sameer Saini',1);
